<template>
  <div id="ListTaches">
    <h2 class="titlePage">Liste des tâches non achevées et non annulées qui ne sont pas arrivées à échéance :</h2>
...
export default {
  ...
  methods: {
    ...
    getTaches: function() {
      this.axios({
        method: 'get',
        url: config.apiURL + '/taches?statut=diff_Achevée&statut=diff_Annulée&dateEnd=supequa_' + moment().format('YYYY-MM-DD'),
